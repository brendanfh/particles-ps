...
(function(exports) {
  ...
  var update = function (v) {
                              ...
                              return function (__copy_h1) {
                                  return function (__copy_v2) {
                                      ...
                                      tco: while (true) {
                                          ...
                                          throw new Error("Failed pattern match at Main line 106, column 25 - line 109, column 44: " + [ l.constructor.name, h1.constructor.name, v2.constructor.name ]);
                                      };
                                  };
                              };
                          };
      ...
      var updateParticles = function (particles1) {
          ...
          var cmp = function (dictOrd) {
              return function (dictApply) {
                  return Data_Function.flip(Control_Apply.lift2(dictApply));
              };
          };
          return $foreign.mapE(particles1)(function (p) {
              return Control_Bind.ifM(Control_Monad_Eff.bindEff)(cmp(Data_Ord.ordNumber)(Control_Monad_Eff.applyEff)(Control_Monad_Eff_Random.random)(Data_Ord.greaterThan(Data_Ord.ordNumber))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(0.97)))(function __do() {
      ...
      var pointTo = function (strength) {
          return function (x) {
              return function (y) {
                  return function (p) {
                      var dy = $$Math.sin($$Math.atan2(y - p.y)(x - p.x));
                      var dx = $$Math.cos($$Math.atan2(y - p.y)(x - p.x));
                      var $39 = {};
                      for (var $40 in p) {
                      ...
                      $39.vx = p.vx + dx * strength;
                      $39.vy = p.vy + dy * strength;
                      return $39;
                  };
              };
          };
      };
      var repel = pointTo(-1.0);
      var mouseCheck = function (v1) {
          return function (cb) {
              return function (particles1) {
                  ...
                  throw new Error("Failed pattern match at Main line 65, column 52 - line 65, column 98: " + [ v1.isDown.constructor.name ]);
              };
          };
      };
      var attract = pointTo(1.0);
      var affectParticles = function (f) {
          return function (x) {
              return function (y) {
                  return Data_Functor.map(Data_Functor.functorArray)(f(x)(y));
              };
          };
      };
      return function __do() {
          var v1 = (function ($68) {
              return updateParticles(mouseCheck(v.rightButton)(affectParticles(repel))($68));
          })(mouseCheck(v.leftButton)(affectParticles(attract))(v.particles))();
          var $49 = {};
          for (var $50 in v) {
  ...
  var main = Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
      return function __do() {
          ...
          return __unused(dictPartial)((function () {
                          ...
                          return function (x) {
                              return function (y) {
                                  return Control_Monad_Eff_Ref.modifyRef(v3)(function (v4) {
                                      var $61 = {};
                                      for (var $62 in v4) {
                                          if (v4.hasOwnProperty($62)) {
                                              $61[$62] = v4[$62];
                                          };
                                      };
                                      $61.leftButton = clickData(pressed)(x)(y);
                                      return $61;
                                  });
                              };
                          };
                          ...
                          return function (x) {
                              return function (y) {
                                  return Control_Monad_Eff_Ref.modifyRef(v3)(function (v4) {
                                      ...
                                      $63.rightButton = clickData(pressed)(x)(y);
                                      return $63;
                                  });
                              };
                          };
              ...
              throw new Error("Failed pattern match at Main line 144, column 8 - line 169, column 27: " + [ v.constructor.name ]);
          })())();
      };
  }));
